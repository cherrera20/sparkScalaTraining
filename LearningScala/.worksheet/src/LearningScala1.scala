object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(132); 
  ...
  val hello: String = "Hola mundo!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(301); 
  ...
  val piconstant = pi;System.out.println("""piconstant  : Double = """ + $show(piconstant ));$skip(37); 
  println(f"asdasd $piconstant%.3f")}
