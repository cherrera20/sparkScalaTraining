object LearningScala1 {
  ...
  val hello: String = "Hola mundo!"               //> hello  : String = Hola mundo!
  ...
  var helloThere: String = hello                  //> helloThere  : String = Hola mundo!
  helloThere = hello + " There!"
  println(helloThere)                             //> Hola mundo! There!
  ...
  val immutableHelloThere = hello + " There!"     //> immutableHelloThere  : String = Hola mundo! There!
  println(immutableHelloThere)                    //> Hola mundo! There!
  ...
  val piconstant = pi                             //> piconstant  : Double = 3.14159265
  println(f"asdasd $piconstant%.3f")              //> asdasd 3.142
